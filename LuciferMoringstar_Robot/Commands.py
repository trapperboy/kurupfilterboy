    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
            ...
            try:
                ...
                await bot.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("📢 Join Updates Channel 📢", url=https://t.me/keralamoviesn)
                            ],
                            [
        ...
        await message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                ...
                InlineKeyboardButton("About", https://t.me/keralamoviesn)
                ]]
            )
        )
        StopPropagation
...
async def bot_info(bot, message):
    buttons = [
        [
            ...
            InlineKeyboardButton('join channl', url=https://t.me/keralamoviesn
        ]
        ]
